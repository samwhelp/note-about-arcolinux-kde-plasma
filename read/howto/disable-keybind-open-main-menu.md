...
| 設定檔路徑 |
| --- |
| [~/.config/kwinrc](https://github.com/samwhelp/arcolinux-kde-plasma-adjustment/blob/main/prototype/main/kde-config/locale/en_us/Breeze-Dark/asset/overlay/etc/skel/.config/kwinrc#L43-L44) |
